...
// Function to generate a valid ObjectId-like string
export function generateValidObjectIdString(): string {
...
export function fixInvalidObjectId(invalidId: string): string {
  if (invalidId.length !== 24) {
    return generateValidObjectIdString();
  }
  return invalidId;
}